...
class Card {
	...
	Card link; //ссылка на следующую карту
...
//	public void selectDraw(final Graphics g, final int x, final int y, final Color color) {
//		g.setColor(color);
//		g.drawRect(x, y, width, height);
//	}
	
//	public void drawBorder(final Graphics g, final int x, final int y){
//		draw(g, x, y);
